...
if __name__ == '__main__': 
    ...
    with open('class_names.json', 'w') as f:
        json.dump(train_dataset.categories, f)  # Using .categories for standard PyTorch datasets
    ...
    # Note: Using the new learning rate
    ...
    for epoch in range(EPOCHS):
        ...
        correct_train_top5 = 0  # <--- NEW TRACKER
        total_train = 0
        ...
        for i, (inputs, labels) in enumerate(train_loader):
            ...
            # Check if the actual label is in those 5 predictions
        ...
        val_loss = 0.0
        correct_val_top1 = 0
        correct_val_top5 = 0 # <--- NEW TRACKER
        total_val = 0
